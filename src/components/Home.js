...
import TodaysDish from '../foodPages/TodaysDish'
import PopularDishes from '../foodPages/PopularDishes'
            ...
            <div className="home">
                <div className="sec-1">
                    <div className="sec-1-left">
                        <div className="sec-1-logo">
                            food Info
                        </div>
                        <div className="sec-1-cont">
                            Instructions, Ingredients and Details to create dishes of different cuisines.
                        </div>
                    </div>
                    <div className="sec-1-right">
                        <div className="sec-1-svg">
                            <svg 
                                ...
                                <path 
                                    ...
                                    fill="#2f2e41"
                                />
                                <circle className="cir-1" cx="476.55994" cy="212.13062" r="27.13799" fill="#ffb9b9"/>
                                <polygon 
                                    className="poly-1"
                                ...
                                <path 
                                    ...
                                    fill="#3f3d56"
                                />
                                <ellipse className="elli-4" cx="62.39599" cy="636.43883" rx="27.80438" ry="10.01827" fill="#3f3d56"/>
                                <path 
                                    className="path-19"
                                    ...
                                    fill="#6c63ff"
                                />
                                <ellipse className="elli-5" cx="63.15104" cy="617.02776" rx="21.03837" ry="8.01462" fill="#6c63ff"/>
                                <ellipse className="elli-6" cx="64.15287" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-7" cx="73.61397" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-8" cx="68.88342" cy="618.39121" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-9" cx="49.96121" cy="618.39121" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-10" cx="54.69176" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-11" cx="59.42232" cy="619.57385" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <path 
                                    className="path-20"
                                    ...
                                    fill="#3f3d56"
                                />
                                <ellipse className="elli-12" cx="667.39599" cy="636.43883" rx="27.80438" ry="10.01827" fill="#3f3d56"/>
                                <path 
                                    className="path-21"
                                    ...
                                    fill="#6c63ff"
                                />
                                <ellipse className="elli-13" cx="668.15104" cy="617.02776" rx="21.03837" ry="8.01462" fill="#6c63ff"/>
                                <ellipse className="elli-14" cx="669.15287" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-15" cx="678.61397" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-16" cx="673.88342" cy="618.39121" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-17" cx="654.96121" cy="618.39121" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-18" cx="659.69176" cy="616.02594" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                                <ellipse className="elli-19" cx="664.42232" cy="619.57385" rx="2.00365" ry="1.00183" fill="#e6e6e6"/>
                            </svg>
                        </div>
                    </div>
